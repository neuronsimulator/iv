...
MarginFrame::MarginFrame(
    Interactor* i, int hmargin1, int vmargin1
) : Frame(i, 0) {
    Init(hmargin1, 0, 0, vmargin1, 0, 0);
}

MarginFrame::MarginFrame(
    const char* name, Interactor* i, int hmargin1, int vmargin1
) : Frame(name, i, 0) {
    Init(hmargin1, 0, 0, vmargin1, 0, 0);
}
...
MarginFrame::MarginFrame(
    Interactor* i,
    int hmargin1, int hshrink1, int hstretch1,
    int vmargin1, int vshrink1, int vstretch1
) : Frame(i, 0) {
    Init(hmargin1, hshrink1, hstretch1, vmargin1, vshrink1, vstretch1);
}
