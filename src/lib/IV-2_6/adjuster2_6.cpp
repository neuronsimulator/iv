...
Mover::Mover(Interactor* i, int delay1, int mt) : Adjuster(i, delay1) {
    Init(mt);
}

Mover::Mover(
    const char* name, Interactor* i, int delay1, int mt
) : Adjuster(name, i, delay1) {
    Init(mt);
}
...
LeftMover::LeftMover(Interactor* i, int delay1) : Mover(i, delay1, MOVE_LEFT) {
    Init();
}

LeftMover::LeftMover(
    const char* name, Interactor* i, int delay1
) : Mover(name, i, delay1, MOVE_LEFT) {
    Init();
}
